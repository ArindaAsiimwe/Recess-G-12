...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <link rel="stylesheet" href="{{ asset('dist/css/adminlte.min.css') }}">
        ...
        <!-- Favicon -->
        <link rel="apple-touch-icon" sizes="76x76" href="{{ asset('black') }}/img/apple-touch-icon.png">
    ...
    <body class="{{ $class ?? '' }}" style="background-image: url('images/tree-growing-coins-stack-with-sunray-saving-money-concept_55710-621.avif'); background-position: center center; background-repeat: no-repeat; background-size: cover;">
        @auth()
            <div class="wrapper">
